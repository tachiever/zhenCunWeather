...
- (UILabel *)lastUpdateTimeLabel
{
    if (!_lastUpdateTimeLabel) {
        ...
        lastUpdateTimeLabel.textColor = MJRefreshDetailLabelTextColor;//MJRefreshLabelTextColor;
        lastUpdateTimeLabel.backgroundColor = [UIColor clearColor];
        lastUpdateTimeLabel.textAlignment = NSTextAlignmentCenter;//NSTextAlignmentLeft;//
...
- (void)layoutSubviews
{
    ...
    CGFloat statusX = 0;//self.mj_width * 0.5 - 40;
    CGFloat statusY = self.mj_height * 0.2;
    CGFloat statusHeight = self.mj_height * 0.3;
    ...
    CGFloat lastUpdateX = 0;//self.mj_width * 0.5 - 40;;

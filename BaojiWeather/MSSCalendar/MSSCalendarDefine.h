...
#define MSS_UTILS_COLORRGBA(r,g,b,a) [UIColor colorWithRed:r/255.0 green:g/255.0 blue:b/255.0 alpha:a]
...
// DateLabel选中时的背景色
#define MSS_SelectBackgroundColor MSS_UTILS_COLORRGBA(20, 37, 83, 0.9)
//#define MSS_SelectBackgroundColor MSS_UTILS_COLORRGB(20, 37, 83)
// DateLabel选中后文字颜色
#define MSS_SelectTextColor [UIColor whiteColor]
// SubLabel文字颜色
#define MSS_SelectSubLabelTextColor [UIColor grayColor];
...
// 节日颜色
#define MSS_HolidayTextColor [UIColor redColor]
//#define MSS_HolidayTextColor MSS_UTILS_COLORRGBA(20, 37, 83,0.9)
// 周末颜色
